<?php
	...
	if (
		...
		if (
            ...
            $categorieC->modifiercategorie($user, $_GET['id']);
            header('refresh:5;url=afficher_categorie.php');
        }
        else
...
<html lang="en">
    ...
    <div class="page-wrapper">
		...
		<?php
			if (isset($_GET['id'])){
				$user = $categorieC->recuperercategorie($_GET['id']);
		...
		<form action="" method="POST">
            <table align="center">
				...
				<tr>
					...
					<td>
						<input type="text" name="nom_categorie" id="nom_categorie" maxlength="20" value = "<?php echo $user['nom_categorie']; ?>">
					</td>
				</tr>
                <tr>
                    <td>
                    ...
                    <td><input type="description" name="description" id="description" maxlength="20" value = "<?php echo $user['description']; ?>"></td>
                </tr>
                
                <tr>
                    <td>
                        <label for="duree_vie">Duree Vie:
                        </label>
                    </td>
                    <td>
                        <input type="number" name="duree_vie" id="duree_vie" value = "<?php echo $user['duree_vie']; ?>">
                    </td>
                </tr>
