<?PHP
    ...
    {
        $listeAnimals=$AnimalC->trierAnimal();
    }
    elseif(isset($_POST['submit2']))
    {
        $listeAnimals=$AnimalC->trierAnimaldesc();
    }
?>
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="Views/afficherAnimal.php">Gestion des animeaux</a>
                                </li>
                                <li>
                                    <a href="Views/afficher_categorie.php">Gestion des categorie</a>
                                </li>
                                <li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <form class="form-header" action="rechercheAnimal.php" method="POST">
                                <input class="au-input au-input--xl" type="text" name="nom" placeholder="Search for datas &amp; reports..." />
                                <button class="au-btn--submit" type="submit" value = "Recherche" name ="search">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Gestion Animal</h2>
                                    <button class="au-btn au-btn-icon au-btn--blue">

                                </div>
                            </div>
                        </div>>
		<button><a href="connexion.php">Ajouter un Animal</a></button>
		<hr>
        <p> <form method="POST" action="">
                                    <input type="submit" class="btn btn-primary shop-item-button" name="submit" value="trier" >
                                    <input type="submit"  class="btn btn-primary shop-item-button" name="submit2" value="trierPrix">
		...
		<table border=1 align = 'center'>
			...
			?>
				<tr>
					...
					<td><?PHP echo $animal['id_vendeur']; ?></td>
					<td><?PHP echo $animal['categorie_animal']; ?></td>
					<td>
