...
{
    $result=$categorieC->getCategorieByname($_POST['nom_categorie']);
    if ($result !== false){ 
?>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <form class="form-header" action="recherche_categorie.php" method="POST">
                                <input class="au-input au-input--xl" type="text" name="nom_categorie" placeholder="Search for datas &amp; reports..." />
