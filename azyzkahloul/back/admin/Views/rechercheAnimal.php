...
$AnimalC = new AnimalC(); 
$AnimalC = $AnimalC->afficherAnimals();
session_start();
...
{
    $result=$AnimalC->getAnimalByname($_POST['nom']);
    if ($result !== false){ 
?>
...
<div class="page-wrapper">
		...
		<tr>
				...
				<tr>
					...
					<td><?PHP echo $result['id_vendeur']; ?></td>
					<td><?PHP echo $result['categorie_animal']; ?></td>
	
					<td>

                    <a href="modifierAnimal.php?id=<?PHP echo $result['id']; ?>"> Modifier </a>
					</td>
					<td>
