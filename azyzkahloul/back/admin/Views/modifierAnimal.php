                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="../assets/../assets/images/icon/logo.png" alt="Animaliaplus" />
                        </a>
		...
		<form action="" method="POST">
            <table align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="id_vendeur" id="id_vendeur" value = "<?php echo $user['id_vendeur']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="categorie_animal" id="categorie_animal" value = "<?php echo $user['categorie_animal']; ?>">
                    </td>
                </tr>
