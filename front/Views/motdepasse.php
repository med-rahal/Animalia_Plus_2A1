                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                ...
                                <div id="erreur"></div>
                                    <div class="l-f-o__pad-box"> 
                                        ...
                                        <span class="gl-text u-s-m-b-30">Remplir le champs email pour recuperer le nouveau mot de passe , veuillez vous consulter votre email.</span>
                                        <form class="l-f-o__form" action="verifpass.php" method ="POST">
