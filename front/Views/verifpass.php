    ...
    session_start();
        ...
        if (isset($_POST['email_client'])){
            ...
            try{
                ...
                $body = "Voici votre email et votre code de verification :<br> 
             - Email  : ". $email."<br>
             - Votre code de vérification: ". $code ."<br> 
              le code de verification est votre mot de passe temporairement <br> 
             Admin Animaliaplus<br>
             Cordialement";
                    ...
                    $mail->Username = "animaliaplus1@gmail.com";
               
                    $mail->Password = "animalia+2021";
               
                    $mail->Subject = "Recuperation de votre compte Animaliplus";
             
                    $mail->setFrom('animaliaplus1@gmail.com');
...
<html lang="en">
  ...
  <head>
        ...
        <title>Recuperation du compte</title> 
                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                ...
                                <div id="erreur"></div>
                                    <div class="l-f-o__pad-box"> 
                                        <h1 class="gl-h1">Recuperation du Compte </h1>
                        
                                        <h1 class="gl-h1">Connexion</h1>

                                        <span class="gl-text u-s-m-b-30">Remplir les champs mot de passe et nouveau mot de passe , veuillez vous connecter maintenant.</span>
                                        <form class="l-f-o__form" method ="POST">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style" type="password" name="mot_passe" id="mot_passe"  placeholder="Entrer le nouveau mot de passe"></div>
                                            <div class="u-s-m-b-30">
                                                <br>
                                                <label class="gl-label" for="confpassword"> Confirmer le nouveau Mot de passe</label><br>
                                                <input class="input-text input-text--primary-style" type="password" name= "confpassword" id="confpassword" placeholder="Confirmer le nouveau mot de passe"></div>
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
