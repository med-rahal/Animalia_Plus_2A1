...
$result=$reclamationC->recupererReclamation($_GET['date_creation']);
...
<div >
	<h2>Réclamation</h2>
		...
		<div class="container">
				...
				<div class=" contact-top">
						...
						<div>		
							<div class="available">
								...
								<ul>
									<li value="<?php echo $type ?>">
										<select name="type">
										<option>réclamation sur un animal</option>
										<option>réclamation sur un produit</option>
										<option>réclamation sur un accessoire</option>
										<option>réclamation sur une livraison</option>
										<option>Autre</option>
									</select></li>
									<div class="clearfix"> </div>
								</ul>
						...
						<div>
							...
							<textarea onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();" name="autre" id="autre" value="Autre" class="form-control"  placeholder="300 Lettres au maximum" /><?php echo $description ?></textarea>
			...
			{
				$description=$_POST['autre'];
				$type=$_POST['type'];
				$datetime = date_create()->format('Y-m-d H:i:s');
				$reclamation1=new reclamation($type,$description,$datetime,"non traitée","","",$mail,$type);
			$reclamationC->modifierReclamation($reclamation1,$Date_creation);
			?>
			<script>
