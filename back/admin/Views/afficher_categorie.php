...
$listeUsers=$categorieanimalC->affichercategorie();

if(isset($_POST['submit']))
{
    $listeUsers=$categorieanimalC->trierCategorie();
}
elseif(isset($_POST['submit2']))
{
    $listeUsers=$categorieanimalC->trierCategoriedesc();
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="header-wrap">
                        <form class="form-header" action="recherche_categorie.php" method="POST">
            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    ...
                    <p> <form method="POST" action="">
                        <input type="submit" class="btn btn-primary shop-item-button" name="submit" value="trierNom " >
                        <br>
                        <input type="submit"  class="btn btn-primary shop-item-button" name="submit2" value=" trierDureeVie">
                    ...
                    <table border=1 align = 'center'>
                        ...
                        foreach($listeUsers as $user){
                            ...
                            <tr>
                                ...
                                <td><?PHP echo $user['duree_vie']; ?></td>
                                <td>
                                    <form method="POST" action="supprimer_categorie.php">
                                        <input type="submit" name="supprimer" value="supprimer">
                                        <input type="hidden" value=<?PHP echo $user['nom_categorie']; ?> name="nom_categorie">
                                    </form>
                                </td>
                                <td>
                                    <a href="modifier_categorie.php?nom_categorie=<?PHP echo $user['nom_categorie']; ?>"> Modifier </a>
                                </td>
                            </tr>
                            <?PHP
                        }
