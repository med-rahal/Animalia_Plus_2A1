...
<body class="animsition">
    ...
    <div class="page-wrapper">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <button><a href="AjoutAlimentation.php">Ajouter Alimentation</a></button>
		<hr>
		<table border=1 align = 'center'>
			...
			?>
				<tr>
					...
					<td>
						<a href="modifierAlimentation.php?id_alimentation=<?PHP echo $id_alimentation['id_alimentation']; ?>"> Modifier </a>
					</td>
				</tr>
     ...
     <a href="pdf.php"> Export PDF </a>
		<a href="pie.php"> Charts </a>
    </form>
