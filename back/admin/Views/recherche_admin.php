...
<?php
if (isset($_POST['nom_administrateur']) && isset($_POST['search']))
{
    $result=$AdminC->getAdminByname($_POST['nom_administrateur']);
    if ($result !== false){ 
?>
...
<div class="page-wrapper">
		...
		<tr>
				...
				<tr>
					...
					<td><?PHP echo $result['nom_administrateur']; ?></td>
					<td><?PHP echo $result['mot_passe']; ?></td>
	
					<td>

						<a type="button" class="btn btn-primary shop-item-button" href = "modifierAdmin.php?id_admin=<?= $result['id_admin'] ?>">Modifier</a>
					</td>
					<td>
						...
						<input type="hidden" value=<?PHP echo $result['id_admin']; ?> name="id_admin">
						</form>
					</td>
