...
include "../Controller/reclamationC.php";
      ...
      // $listeReclamations=$reclamation1C->rechercherreclamations($_POST['utilisateur']); 
...
$resulat=rowCount($db,"select * from messages");
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                       ...
                       <li> <div class="noti-wrap"> <p> Messages </p>
                       
                                    <div class="noti__item js-item-menu">
                                        <i class="zmdi zmdi-comment-more"></i>
                                        <span></span>
                                        <span class="quantity"> <?php echo $resulat ?></span>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <input name="utilisateur" class="form-control" placeholder="recherche" required autofocus>
                    ...
                    <ul>
									<li>
										<select name="type">
										<option>date_creation</option>
										
										<option>descri</option>
										
									</select></li>
                        <input type="submit" value="Rechercher" name="trier" >
                    </span>
...
foreach($listeReclamations as $row){
    ...
    <td><a href="dashbordDetaille.php?date_creation=<?PHP echo $row['date_creation']; ?>" class="add-cart cart-check">Ouvrir</a></td>
    <td><a href="dashbordSupp.php?date_creation=<?PHP echo $row['date_creation']; ?>" class="add-cart cart-check">Supprimer</a></td>
    </tr>
    <?PHP
}
?>
