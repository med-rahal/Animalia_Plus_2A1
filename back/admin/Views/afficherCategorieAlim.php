<?PHP
	...
	$listeCategorie=$CategorieN->afficherCategorie();
...
<body class="animsition">
    ...
    <div class="page-wrapper">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Gestion des Categories Alimentation </h2>
                        ...
                        <button><a href="ajoutCategorieAlim.php">Ajouter un Categorie Alimentation</a></button>
		<hr>
		<table border=1 align = 'center'>
			...
			<?PHP
				foreach($listeCategorie as $id_categorie){
			?>
				<tr>
					<td><?PHP echo $id_categorie['id_categorie']; ?></td>
					<td><?PHP echo $id_categorie['nom_categorie']; ?></td>
					<td><?PHP echo $id_categorie['description']; ?></td>
					<td>
						<form method="POST" action="supprimerCategorieAlim.php">
						<input type="submit" name="supprimer" value="delete">
						<input type="hidden" value=<?PHP echo $id_categorie['id_categorie']; ?> name="id_categorie">
						</form>
					</td>
					<td>
						<a href="modifierCategorieAlim.php?id_categorie=<?PHP echo $id_categorie['id_categorie']; ?>"> Modifier </a>
					</td>
				</tr>
