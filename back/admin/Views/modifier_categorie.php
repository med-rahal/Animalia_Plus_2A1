...
if (
    ...
    if (
        ...
        $categorieanimalC->modifiercategorie($user, $_GET['nom_categorie']);
        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h2 class="title-1">Gestion Categorie Animeaux</h2>
                    ...
                    <?php
                    if (isset($_GET['id'])){
                        $user = $categorieanimalC->recuperercategorie($_GET['id']);
                        ?>
