...
<div class="container">
  ...
  <form class="form-inline">
    <div class="row">
      ...
      <div class="form-group col-sm-3">
        <label for="phoneMobile">PRIX</label>
        <br>
        <input type="text" class="form-control" id="phoneMobile" placeholder="DT">
      </div>
      

    </div>
    <p class="small">Retour <a href="index.html" target="_blank">accueil</a>.</p>
    <div class="qr-out row">
      <img class="qr-img" alt="">
    </div>
    <div class="biscard-out">
    </div>
  </form>
</div>
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/1.11.3/jquery.min.js'></script><script  src="../assets/js/qr.js"></script>
