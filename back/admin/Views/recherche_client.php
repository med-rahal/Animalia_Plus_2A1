...
<?php
if (isset($_POST['nom_client']) && isset($_POST['search']))
{
    $result=$ClientC->getclientByname($_POST['nom_client']);
    if ($result !== false){ 
?>
...
<div class="page-wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <input class="au-input au-input--xl" type="text" name ="nom_client" placeholder="Search for datas &amp; reports..." />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">resultat du recherche</h2>
		...
		<tr>
				...
				<tr>
					...
					<td><?PHP echo $result['prenom_client']; ?></td> 
                    <td><?PHP echo $result['date_naissance']; ?></td> 
                    <td><?PHP echo $result['type_client']; ?></td> 
					<td><?PHP echo $result['email_client']; ?></td>
					<td><?PHP echo $result['login_client']; ?></td> 
                    <td><?PHP echo $result['mot_passe']; ?></td> 
					...
					<td>
						...
						<input type="hidden" value=<?PHP echo $result['id_client']; ?> name="id_client">
						</form>
					</td>
