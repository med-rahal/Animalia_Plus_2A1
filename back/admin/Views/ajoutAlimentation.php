<?php
    ...
    include_once  "../Controller/AlimentationC.php";
    ...
    if (
        ...
        if (
            ...
            $userC->ajouterAlimentation($user);
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Gestion des Alimentations</h2>
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="nom_alimentation" id="nom_alimentation" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="ref_alimentation">Réference:
                        </label>
                    </td>
                    <td><input type="text" name="ref_alimentation" id="ref_alimentation" maxlength="20"></td>
                </tr>
                
                <tr>
                    <td>
                        <label for="categorie_alimentation">Catégorie:
                        </label>
                    </td>
                    <td>
