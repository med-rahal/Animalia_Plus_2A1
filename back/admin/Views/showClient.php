...
{
    $clients=$ClientC->trierclient();
}
elseif(isset($_POST['submit2']))
{
    $clients=$ClientC->trierclientdesc();
}
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="recherche_client.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <input type="submit"  class="btn btn-primary shop-item-button" name="submit2" value="trierD">
